...
import {
  LayoutDashboard, MapPin, MessageSquare, User, LogOut, Menu, Key, Building, FileText, Map
} from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
...
export default function LayoutImobiliaria({ children }) {
  ...
  const menuItems = [
    ...
    {
      title: "Loteamentos",
      url: createPageUrl("PortalImobiliariaLoteamentos"),
      icon: Map,
    },
    {
      title: "Lotes",
    ...
    {
      title: "Pré-Intenções",
      url: createPageUrl("PortalImobiliariaIntencoes"),
      icon: FileText,
    },
    {
      title: "Mensagens",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <footer className="bg-white border-t border-gray-200 mt-auto py-4">
        <div className="max-w-7xl mx-auto px-4 text-center text-sm text-gray-600">
          © 2026 Riviera Incorporadora - Portal Imobiliária v4.7.0
        </div>
      </footer>
