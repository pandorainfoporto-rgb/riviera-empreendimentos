  ...
  useEffect(() => {
    if (lote) {
      setFormData({
        ...
        area: typeof lote.area === 'number' ? lote.area : (lote.area || ""),
        frente: typeof lote.frente === 'number' ? lote.frente : (lote.frente || ""),
        fundo: typeof lote.fundo === 'number' ? lote.fundo : (lote.fundo || ""),
        lado_esquerdo: typeof lote.lado_esquerdo === 'number' ? lote.lado_esquerdo : (lote.lado_esquerdo || ""),
        lado_direito: typeof lote.lado_direito === 'number' ? lote.lado_direito : (lote.lado_direito || ""),
        valor_m2: typeof lote.valor_m2 === 'number' ? lote.valor_m2 : (lote.valor_m2 || ""),
        valor_total: typeof lote.valor_total === 'number' ? lote.valor_total : (lote.valor_total || ""),
