...
export default function DocumentosLista({ documentos, unidades, cronogramasObra, isLoading, tipo, onEdit, onDelete }) {
  if (isLoading) {
    return (
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <FileText className="w-4 h-4 text-[var(--wine-600)]" />
                  ...
                  <div className="space-y-1 text-sm text-gray-600">
                    ...
                    {doc.descricao && (
                      <p className="text-gray-500 mt-2">{doc.descricao}</p>
                    )}
                  </div>
                </div>
